...
// Use standard environment variables so this route works on Vercel as well
// as on Cloudflare-compatible runtimes.
export async function POST(request:Request){
 ...
 const sources=retrieveHelp(input.query);const config={GENERATION_API_KEY:process.env.GENERATION_API_KEY,GENERATION_URL:process.env.GENERATION_URL,GENERATION_MODEL:process.env.GENERATION_MODEL};
